...
alignel* gapped_extend
   (seq*			seq1,
	...
	// one for an additional self-alignment-- see note (1) in init_from_anchors);
	// note that batched_segments sorts the HSPs in descreasing score order (per
	// batch)
