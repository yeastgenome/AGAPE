...
$SCRIPTS/conv_scf_pos $comb_annot/head.txt $comb_annot/add1.genes.gff > $comb_annot/genes.gff
...
$SCRIPTS/conv_scf_pos $comb_annot/head.txt $comb_annot/add2.genes.gff > $comb_annot/genes.gff
